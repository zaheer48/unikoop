            ...
            <div class="col-md-12 card middlecontainer">
                <div class="card card-profile shadow">
                    <div class="card-body">
                        ...
                        {{-- <hr class="my-4"> --}}
                        <form method="POST" action="{{ route('service-bank.update',$details->id)}}">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-1"></div>
                                <div class="col-md-10">
                                    <h3 style="padding: 5px;">Bank 2</h3>
                                </div>
                                <div class="col-md-1"></div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-1"></div>
                                <div class="col-md-10">
                                    <h3 style="padding: 5px;">Bank 1</h3>
                                </div>
                                <div class="col-md-1"></div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="iban_2" placeholder="IBN" class="form-control"
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="bic_2" placeholder="BIC" class="form-control"
                                            value="{{$details->bic_2}}">
                                        @if ($errors->has('bic_2'))
                                        <span class="invalid-feedback" role="alert" style="color:red;">
