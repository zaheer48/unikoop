                ...
                <div class="col-md-12">
                    <!-- <div class="card-body">
                        <p class="alert alert-info p-3">
                            ...
                            <a href="{{route('invoice')}}" style="text-decoration: underline;">Invoice
                            </a>,
                            <a href="/email-templates" style="text-decoration: underline;">Email</a>,
                            <a href="/packinglist-templates" style="text-decoration: underline;">Packing List</a> by
                            ...
                            <div class="row">
                                    ...
                                    <div class="input-group text-start gap-2">
                                        <div class="form-outline ">
                                            <input type="text" name="bestelnummer" id="bestelnummer"
                                                class="form-control" placeholder="bestelnummer" required="" value="">
                                        </div>
                                        ...
                                        <input type="button" id="check_invoice" value="Fetch Info"
                                ...
                                <div>
                                        ...
                                        <div class="col-md-12">
                                            <form name="register" method="post" id="my_form"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <input style="margin-bottom: 5px;" type="email" name="email"
                                                                id="or_email" value="" class="form-control">
                                                            @if ($errors->has('email'))
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <input style="margin-bottom: 5px;" type="text" name="cc"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <input type="hidden" name="finvoice_input"
                                                                id="finvoice_input" value="">
                                                            <input type="hidden" name="fpackinglist_input"
                                                                id="fpackinglist_input" value="">
                                                            <input type="hidden" name="sinvoice_input"
                                                                id="sinvoice_input" value="">
                                                            <input type="hidden" name="tpackinglist_input"
                                                                id="tpackinglist_input" value="">
                                                            <a style="display:none" href="" id="f_anchor">Invoice</a>
                                                            <a style="display:none" href="" id="sf_anchor">Packing
                                                                List</a>
                                                            <a style="display:none" href=""
                                                                id="second_anchor">Invoice</a>
                                                            <a style="display:none" href="" id="third_anchor">Packing
                                                                List</a>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div style="text-align:center; margin-bottom:20px">
                                        <form name="register" method="post" id="check_invoice_form2" action=""
                                            enctype="multipart/form-data" style="display:none">
                                            {{ csrf_field() }}
                                            <input type="text" name="bestelnummer" id="bestelnummer2"
                                                class="form-control" placeholder="bestelnummer" required="" value="">
                                        </form>
                                    </div>
                                </div>
                                @else
                                <p class="alert alert-danger">Please configure your email template in settings tab area
                                </p>
                                @endif
                            </div>
                        </div>
        ...
        success: function(data) {
            if (data.message == 'No record found against this Order ID') {
                ...
                if (data.check_invoice_message == '1') {
                    ...
                    $("#second_anchor").attr("href", "/download-invoice-pdf/" +
                        check_invoice_orderID);
                ...
                if (data.check_invoice_message == '2') {
                    ...
                    $("#third_anchor").attr("href", "/download-packinglist-pdf/" +
                        check_invoice_orderID);
                    $("#finvoice_input").attr("value", "");
                    $("#fpackinglist_input").attr("value", "");
                ...
                if (data.check_invoice_message == '1-2') {
                    ...
                    var check_invoice_orderID = data.check_invoice_orderID;
                    // var f_anchor_route = "{{route('download.invoice.pdf', '')}}"+"/"+data.check_invoice_orderID;
                    // $("#f_anchor").attr("href", "/bol/create_invoice_2/" + check_invoice_orderID);
                    $("#f_anchor").attr("href", "{{route('download.invoice.pdf', '')}}"+"/"+data.check_invoice_orderID);
                    $("#sf_anchor").attr("href", "{{route('download.packinglist.pdf', '')}}"+"/"+data.check_invoice_orderID);
                    $("#tpackinglist_input").attr("value", "");
                    $("#sinvoice_input").attr("value", "");
