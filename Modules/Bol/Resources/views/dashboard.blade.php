                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><div class="btn-group mb-2">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        <a class="dropdown-item" href="{{url('/bol/orders/'.$bol_rec_id)}}">Bol Update</a>
                                                                        <a class="dropdown-item" href="{{ route('bolexport', $bol_rec_id) }}">Pick List(Products)</a>
                                                                        <a class="dropdown-item" href="{{ route('Exportqty', $bol_rec_id) }}">Pick List(Quantity)</a>
                                                                        <a class="dropdown-item" href="{{url('/bol/dhl_csv/bol.com (NL)/'.$bol_rec_id)}}">DHL CSV</a>
                                                                        <a class="dropdown-item" href="{{url('/bol/packing_list/bol.com (NL)/'.$bol_rec_id)}}">Packing List</a>
                                                                        <a class="dropdown-item" href="{{url('/bol/create_invoice/bol.com (NL)/'.$bol_rec_id)}}">Invoice</a>
