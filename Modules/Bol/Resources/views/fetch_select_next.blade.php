            ...
            <div class="col-xl-12">
                ...
                <div class="panel panel-default">
                    <form action="{{ url('/bol/fetch', $bol) }}" id="fetch-form" method="POST"
                        ...
                        $dpd_total_price = Auth::user()->price_per_label ? Auth::user()->price_per_label_dpd :
                        $dpd_price;
                        @endphp
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table class="table table-borderless table-nowrap table-hover table-centered m-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><img src="{{ asset('dpd_logo.svg') }}" alt="" style="width: 134px;">
                                            </td>
                                            <td>
                                                <span>
                                ...
                                <div class="card">
                                    ...
                                    <div class="form-group my-2" id="loading-btn">
                                        @if (isset($counts['dhl']) || isset($counts['dpd']) ||
                                        isset($counts['dhl_today']))
                    ...
                    <div class="col-md-12">                    
                        <table class="table text-center">
                            <tbody>
                                ...
                                <tr>
                                    <td><img src="{{ asset('dpd_logo.svg') }}" alt="" style="width: 134px;"></td>
                                    <td>
                                        <span>
