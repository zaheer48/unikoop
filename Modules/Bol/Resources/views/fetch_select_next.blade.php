 ...
 <!-- ============================================================== -->
    ...
    <div class="container mt-10">
        <div class="row">
            ...
            <div style="background-color:  var(--ct-form-check-input-checked-bg-color) ; padding: 20px; margin-bottom: 6px; color: #fff;">
                                        <style>
                                            .span-txt-nl {
                                                margin-right: 40px;
                                                float: right;
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <table class="table text-center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span style="background-color: transparent; color: #023567; font-weight: 500; padding: 13px 15px; font-size: 14px;">
                                                            Selected: {{ ( $counts['dpd']) ?? 0 }} /
                                                            Total: &euro;{{ (( $counts['dpd']) ?? 0) *  (int)$dpd_total_price }}
                                                        </span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span style="background-color: transparent; color: #023567; font-weight: 500; padding: 13px 15px; font-size: 14px;">
                                                            ...
                                                            Total: &euro;{{ (($counts['dhl_today']) ?? 0) * $dhl_total_price }}
...
@section('js')
    ...
    <script type="text/javascript">
        function loginLoadingBtn() {
            document.getElementById('loading-btn').innerHTML = '<button class="btn btn-primary btn-lg disabled">Fetching <svg xmlns="http://www.w3.org/2000/svg" width="24" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-loader spin ml-2"><line x1="12" y1="2" x2="12" y2="6"></line><line x1="12" y1="18" x2="12" y2="22"></line><line x1="4.93" y1="4.93" x2="7.76" y2="7.76"></line><line x1="16.24" y1="16.24" x2="19.07" y2="19.07"></line><line x1="2" y1="12" x2="6" y2="12"></line><line x1="18" y1="12" x2="22" y2="12"></line><line x1="4.93" y1="19.07" x2="7.76" y2="16.24"></line><line x1="16.24" y1="7.76" x2="19.07" y2="4.93"></line></svg></button>';
            return true;
