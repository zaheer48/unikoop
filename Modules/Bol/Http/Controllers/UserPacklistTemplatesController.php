...
class UserPacklistTemplatesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('template.gold.dhl.packinglist-templates.index', compact('templates'));
    }
...
//
    ...
    public function edit($id)
    {
        $preview = DB::table('packinglist_previews')
            ...
            ->first();
        return view('template.gold.dhl.packinglist-templates.edit', compact('preview'));
    }
...
//                Image::make($thumbnailImage->getRealPath())->resize(120, 37)->save($path);
    ...
    public function preview($id)
    {
        $preview = DB::table('user_packlist_previews')
            ...
            ->where('user_packlist_previews.id',$id)
            ->first();
        return view('template.gold.dhl.packinglist-templates.preview', compact('preview'));
    }
