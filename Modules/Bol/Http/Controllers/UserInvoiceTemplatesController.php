...
//                Image::make($thumbnailImage->getRealPath())->resize(120, 37)->save($path);
    ...
    public function preview($id)
    {
        $preview = DB::table('user_invoice_previews')
            ...
            ->where('user_invoice_previews.id', $id)
            ->first();
        return view('template.gold.dhl.invoice-templates.preview', compact('preview'));
    }
    ...
    {
        return view('template.gold.dhl.invoice-templates.service-bank.create');
    }
    ...
    {    
        ...
        return view('template.gold.dhl.invoice-templates.service-bank.edit',compact('details'));
