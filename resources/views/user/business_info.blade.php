            ...
            <div class="col-md-12 card middlecontainer">
                <div class="card card-profile shadow">
                    <div class="card-body">
                        ...
                        {{-- <hr class="my-4"> --}}
                        <?php $user = \Auth::user();
                        $user_address = \DB::table('bussiness_address')
                                ...
                                <div class="col-md-5">
                                    <div class="form-group mt-2">
                                        ...
                                        <select class="form-control" id="kycBusinessInfo_Country"
                                            ...
                                            <option value="NL"
                                                @if ($user_address->country ?? '') {{ $user_address->country == 'NL' ? 'selected' : '' }} @endif>
                                                Netherlands</option>
                                            <option value="BE"
                                                @if ($user_address->country ?? '') {{ $user_address->country == 'BE' ? 'selected' : '' }} @endif>
                                                Belgium</option>
                                        </select>
                                    </div>
                                </div>
