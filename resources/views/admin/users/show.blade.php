                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="business-tab" data-bs-toggle="tab"
                                        ...
                                        aria-selected="false">Business Info</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="recharged-tab" data-bs-toggle="tab"
                                        data-bs-target="#recharged" type="button" role="tab" aria-controls="recharged"
                                        aria-selected="false">Recharged History</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="labels-tab" data-bs-toggle="tab" data-bs-target="#labels"
                                        type="button" role="tab" aria-controls="labels" aria-selected="false">All
                                        Labels</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="dhl-tab" data-bs-toggle="tab" data-bs-target="#dhl"
                                        type="button" role="tab" aria-controls="dhl" aria-selected="false">DHL
                                        Labels</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="dpd-tab" data-bs-toggle="tab" data-bs-target="#dpd"
                                        type="button" role="tab" aria-controls="dpd" aria-selected="false">DPD
                                        Labels</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="custom-tab" data-bs-toggle="tab" data-bs-target="#custom"
                                        type="button" role="tab" aria-controls="custom" aria-selected="false">Custom
                                        Labels </button>
                                </li>
                            </ul>
                                ...
                                <div class="tab-pane fade show active" id="profile" role="tabpanel"
                                    ...
                                    <div class="row" style="padding: 30px;">
                                        <div class="col-md-12">
                                            ...
                                            <p>Credit Limit:
                                                <strong>&euro;{{ number_format($user->credit_limit, 2) }}</strong></p>
                                            ...
                                            <p>Bol Client Secret (BE): <strong>{{ $user->bol_be_client_secret }}</strong>
                                            </p>
                                            <p>Price Per DHL Label:
                                                <strong>&euro;{{ number_format($user->price_per_label, 2) }}</strong></p>
                                            <p>Price Per DPD Label:
                                                <strong>&euro;{{ number_format($user->price_per_label_dpd, 2) }}</strong>
                                            </p>
                                            @php
                                                $username = \App\Models\User::select('username')
                                                    ->where('id', $user->create_by)
                                                    ->first();
                                            @endphp
                                            <p>Added On:
                                                <strong>{{ $user->created_at ? $user->created_at->toFormattedDateString() : '' }}</strong>
                                            </p>
                                            <p>Created By:
                                                <strong>{{ isset($username->username) ? $username->username : 'unknown' }}</strong>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="tab-pane fade" id="recharged" role="tabpanel"
                                                    ...
                                                    <tbody>
                                                        @foreach ($transactions->where('type', 'Wallet') as $transaction)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td height="30">{{ $summary->currency ?? '' }}
                                                                    {{ $transaction->amount }}</td>
                                                                <td height="30">{{ $summary->payment_method ?? '' }}
                                                                </td>
                                        ...
                                        <div class="row" style="padding: 30px;">
                                            <div class="col-md-12">
                                                ...
                                                <table  class="table table-striped" id="custom_table" style="width:100%">
                                                    ...
                                                    <tbody>
                                                        @php
                                                            $orders = \App\Models\CustomOrder::where('user_id', $user->id)
