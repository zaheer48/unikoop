                                            ...
                                            @if (count($users) > 0)
                                                @foreach ($users as $user)
                                                    <tr>
                                                        ...
                                                        <td>&euro;
                                                            {{ $user->credit_limit ? number_format($user->credit_limit, 2) : 0.0 }}
                                                        </td>
                                                        <td>&euro;
                                                            {{ $user->price_per_label ? number_format($user->price_per_label, 2) : 0.0 }}
                                                        </td>
                                                        <td>&euro;
                                                            {{ $user->price_per_label_dpd ? number_format($user->price_per_label_dpd, 2) : 0.0 }}
                                                        </td>
                                                        <?php $admin = \App\Models\User::select('username')
                                                        ...
                                                        <td>
                                                            <div class="btn-group mb-2">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    ...
                                                                    {{-- </form> --}}
                                                                    <a class="edit dropdown-item"
                                                                        href="{{ route('users.show', $user->id) }}">View
                                                                        Report</a>
