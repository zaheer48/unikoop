                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="card bg-pattern">
                            <div class="card-body">
                                <div class="text-center">
                                    <img src="assets/images/companies/unikoop.jpg" alt="logo" class="avatar-xl rounded-circle mb-3">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card bg-pattern">
                            <div class="card-body">
                                <div class="text-center">
                                    <img src="assets/images/companies/bol.jpeg" alt="logo" class="avatar-xl rounded-circle mb-3">
                    ...
                    <div class="col-lg-4">
                        <div class="card bg-pattern">
                            <div class="card-body">
                                <div class="text-center">
                                    <img src="assets/images/companies/EBay1.png" alt="logo" class="avatar-xl rounded-circle mb-3">
                    ...
                    <div class="col-lg-4">
                        <div class="card bg-pattern">
                            <div class="card-body">
                                <div class="text-center">
                                    <img src="assets/images/companies/homee.png" alt="logo" class="avatar-xl rounded-circle mb-3">
