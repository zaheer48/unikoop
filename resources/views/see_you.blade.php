...
<html lang="en">
    <head>
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" href="{{ isset($settings->site_fav_icon) ? asset('portal/'.$settings->site_fav_icon) : '' }}">
		<!-- Bootstrap css -->
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-4">
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-white-50">Back to <a href="{{ route('home') }}" class="text-white ms-1"><b>Sign In</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
                    </div> <!-- end col -->
