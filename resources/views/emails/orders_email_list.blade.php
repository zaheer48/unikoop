...
?>
        ...
        <div class="col-md-8">
          <div class="search">
            ...
            <form action="" method="post" class="form-inline">  
                  ...
                  <input type="text" class="form-control" value="Search..." name="search" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Search...';}" required="">
  ...
  <div class="text-right">
    ...
    Check all <input type="checkbox" id="checking" onclick="check_all('click1');" value="Get" />
  </div><br>  
