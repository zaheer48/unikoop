@extends('layouts.app')
@section('title','Add Email Template | Unikoop')
@section('content')
                        ...
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal mx-5" action="{{ url('/email-templates') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea class="form-control" name="email_body" id="edit_profile_description" rows="18" style="resize: vertical;" placeholder="Enter Faq Description"></textarea>
                                    </div>
                                </div>

                                <div class="form-group add-product-footer text-center float-start my-2">
                                    <button name="addProduct_btn" type="submit" class="btn btn-primary product-btn mb-4 ">
